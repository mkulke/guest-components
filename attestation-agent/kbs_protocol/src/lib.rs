...
//!
//!     // A background-check model client can also generate a token
...
//! use kbs_protocol::token_provider::MockedTokenProvider;
//!
//! async fn passport() {
//!     let token_provider = Box::<MockedTokenProvider>::default();
...
//! `evidence_provider` to retrieve a new token.
